...
public class StrUtil
{
    ...
    {
        if (StringTools.isNotEmpty(url) && StringTools.isNotEmpty(tokenId))
        {
            
            // modify by wkf39172 at 2012-3-22 for IRD-22810 begin
            if (containMark(url, "?"))
            {
                if (isVerifyIP)
                {
            ...
            // modify by wkf39172 at 2012-3-22 for IRD-22810 end
        }
